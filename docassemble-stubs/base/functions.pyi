...
def get_chat_log(utc: bool = ..., timezone: str | None = ...): ...
def user_logged_in() -> bool: ...
def device(ip: bool = ...) -> Optional[UserAgent]: ...
def parse_accept_language(language_header: str, restrict: bool = ...) -> list: ...
...
def states_list(country_code: Optional[str] = ..., abbreviate: bool = ...): ...
...
def invite_user(email_address, privilege: Incomplete | None = ..., send: bool = ...): ...
...
class CustomDataType(metaclass=CustomDataTypeRegister):
    include_variable_name: bool

    @classmethod
    def validate(cls, item): ...
    @classmethod
    def call_validate(cls, item, variable_name, data): ...
    @classmethod
