...
def word_to_pdf(in_file, in_format, out_file, pdfa: bool = ..., password: Incomplete | None = ..., owner_password: Incomplete | None = ..., update_refs: bool = ..., tagged: bool = ..., filename: Incomplete | None = ..., retry: bool = ...): ...
...
def concatenate_files(path_list, pdfa: bool = ..., password: Incomplete | None = ..., owner_password: Incomplete | None = ...): ...
