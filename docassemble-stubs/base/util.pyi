...
class DAList(DAObject):
    ...
    complete_attribute: None | str | list | DAList
    ...
    def complete_elements(self, complete_attribute: str | list | DAList | None = ...): ...
    def _complete_attributes(self, complete_attribute: str | list | DAList | None = ...) -> list: ...
    def _validate(self, item_object_type, complete_attribute: str | list | DAList) -> None: ...
    _appending_allowed: bool
    def _allow_appending(self) -> None: ...
    def _disallow_appending(self) -> None: ...
    _necessary_length: Incomplete
    def gather(self, number: int | None = ..., item_object_type: Incomplete | None = ..., minimum: Incomplete | None = ..., complete_attribute: str | list | DAList | None = ...): ...
    ...
    def add_action(self, label: str | None = ..., message: str | None = ..., url_only: bool = ..., icon: str = ..., color: str | None = ..., size: str = ..., block: bool | None = ..., classname: str | None = ...) -> str: ...
...
class DADict(DAObject):
    ...
    def gathering_started(self) -> bool: ...
    def number_gathered(self, if_started: bool = ...) -> int: ...
    def number_as_word(self, language: str | None = ...): ...
