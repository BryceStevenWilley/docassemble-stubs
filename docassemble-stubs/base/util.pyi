...
class DAObject:
    ...
    def is_relation(self, target, relationship_type, tree, self_is: str = ..., filter_by: Incomplete | None = ...) -> bool: ...
...
class DAFile(DAObject):
    ...
    def show(self, width: Incomplete | None = ..., wait: bool = ..., alt_text: Incomplete | None = ...): ...
...
class DAFileList(DAList):
    ...
    def size_in_bytes(self): ...
    def slurp(self, auto_decode: bool = ...): ...
    def show(self, width: Incomplete | None = ..., alt_text: Incomplete | None = ...): ...
    def path(self): ...
    def get_docx_variables(self): ...
    def get_pdf_fields(self): ...
    def url_for(self, **kwargs): ...
...
class DAEmailRecipient(DAObject):
    ...
    name: Incomplete
    def init(self, *pargs, **kwargs) -> None: ...
    def email_address(self, include_name: Incomplete | None = ...): ...
    def exists(self): ...
    def __str__(self): ...
...
def month_of(the_date, as_word: bool = ..., language: Incomplete | None = ...): ...
def day_of(the_date, language: Incomplete | None = ...): ...
def dow_of(the_date, as_word: bool = ..., language: Incomplete | None = ...): ...
def year_of(the_date, language: Incomplete | None = ...): ...
...
def timezone_list(): ...
def returning_user(minutes: Incomplete | None = ..., hours: Incomplete | None = ..., days: Incomplete | None = ...): ...
...
class IndividualName(Name):
    ...
    def defined(self): ...
    def familiar(self): ...
    def full(self, middle: str = ..., use_suffix: bool = ..., **kwargs): ...
    def firstlast(self): ...
    def lastfirst(self): ...
    def middle_initial(self, with_period: bool = ...): ...
...
class Address(DAObject):
    ...
    def init(self, *pargs, **kwargs) -> None: ...
    def __str__(self): ...
    def on_one_line(self, include_unit: bool = ..., omit_default_country: bool = ..., language: Incomplete | None = ..., show_country: Incomplete | None = ...): ...
    def _map_info(self): ...
    ...
    def geocode(self, address: Incomplete | None = ..., reset: bool = ...): ...
    norm: Incomplete
    ...
    def line_one(self, language: Incomplete | None = ...): ...
    def line_two(self, language: Incomplete | None = ...): ...
...
class Person(DAObject):
    ...
    def is_user(self): ...
    def address_block(self, language: Incomplete | None = ..., international: bool = ..., show_country: bool = ...): ...
...
class Individual(Person):
    ...
    def identified(self): ...
    def age_in_years(self, decimals: bool = ..., as_of: Incomplete | None = ...): ...
...
class Organization(Person):
    ...
    def init(self, *pargs, **kwargs) -> None: ...
    def will_handle(self, problem: Incomplete | None = ..., county: Incomplete | None = ...): ...
    def _map_info(self): ...

def get_sms_session(phone_number, config: str = ...): ...
def initiate_sms_session(phone_number, yaml_filename: Incomplete | None = ..., email: Incomplete | None = ..., new: bool = ..., send: bool = ..., config: str = ...): ...
def terminate_sms_session(phone_number, config: str = ...): ...
def send_sms(to: Incomplete | None = ..., body: Incomplete | None = ..., template: Incomplete | None = ..., task: Incomplete | None = ..., task_persistent: bool = ..., attachments: Incomplete | None = ..., config: str = ..., dry_run: bool = ...): ...
...
def url_ask(data): ...
def action_button_html(url, icon: Incomplete | None = ..., color: str = ..., size: str = ..., block: bool = ..., label: str = ..., classname: Incomplete | None = ..., new_window: Incomplete | None = ..., id_tag: Incomplete | None = ...): ...
