...
class azureobject:
    ...
    def get_secret(self, key_vault_reference) -> None: ...
    def replace_secrets(self, match) -> None: ...
    def load_with_secrets(self, config) -> None: ...
...
class azurekey:
    ...
    def generate_url(self, seconds, display_filename: Union[Incomplete, None] = ..., content_type: Union[Incomplete, None] = ..., inline: bool = ...): ...
...
class azuresecret:
    ...
    def get_secret_as_string(self) -> None: ...
