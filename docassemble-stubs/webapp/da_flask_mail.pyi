...
class Message(FlaskMessage):
    sender: Incomplete
    def __init__(self, subject: str = ..., recipients: Incomplete | None = ..., body: Incomplete | None = ..., html: Incomplete | None = ..., alts: Incomplete | None = ..., sender: Incomplete | None = ..., cc: Incomplete | None = ..., bcc: Incomplete | None = ..., attachments: Incomplete | None = ..., reply_to: Incomplete | None = ..., date: Incomplete | None = ..., charset: Incomplete | None = ..., extra_headers: Incomplete | None = ..., mail_options: Incomplete | None = ..., rcpt_options: Incomplete | None = ...) -> None: ...
